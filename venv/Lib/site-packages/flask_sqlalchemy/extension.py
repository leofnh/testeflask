...
class SQLAlchemy:
    ...
    After creating the extension, create model funcoes by subclassing :attr:`Model`, and
    table funcoes with :attr:`Table`. These can be accessed before :meth:`init_app` is
    ...
    :param add_models_to_shell: Add the ``db`` instance and all model funcoes to
        ``flask shell``.
