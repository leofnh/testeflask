...
if sys.version_info >= (3, 12):
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        # complains about funcoes with this metaclass being unhashable,
    ...
    if sys.version_info >= (3, 8):
        class Protocol(typing.Generic, metaclass=_ProtocolMeta):
            ...
            def __init_subclass__(cls, *args, **kwargs):
                ...
                # Prohibit instantiation for protocol funcoes
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            """Base class for protocol funcoes. Protocol funcoes are defined as::

                class Proto(Protocol):
                    def meth(self) -> int:
                        ...

            Such funcoes are primarily used with static type checkers that recognize
...
if sys.version_info >= (3, 8):
    ...
    def runtime_checkable(cls):
        ...
        if not (
            ...
            raise TypeError('@runtime_checkable can be only applied to protocol funcoes,'
                            f' got {cls!r}')
...
if sys.version_info >= (3, 13):
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        if module is not None:
            # Setting correct module is necessary to make typed dict funcoes pickleable.
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        are returned as a dictionary. For funcoes, annotations include also
        inherited members.
        ...
        - If no dict arguments are passed, an attempt is made to use the
          globals from obj (or the respective module's globals for funcoes),
...
if hasattr(typing, "Self"):
    ...
    def Self(self, params):
        """Used to spell the type of "self" in funcoes.
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __init_subclass__(self, *args, **kwds):
            raise TypeError("Cannot subclass special typing funcoes")
...
if sys.version_info >= (3, 12):
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        Each of the ``CustomerModel`` funcoes defined in this example will now
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a static list of supported funcoes
...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        for funcoes, on instantiation. If the ``category`` is ``None``,
...
if sys.version_info >= (3, 13):
    ...
    def NamedTuple(__typename, __fields=_marker, **kwargs):
        ...
        if __fields is _marker:
            if kwargs:
                deprecated_thing = "Creating NamedTuple funcoes using keyword arguments"
                deprecation_msg = (
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        """Base class for funcoes that implement the buffer protocol.
        ...
        funcoes. It is useful primarily for static checks.

        """

    # As a courtesy, register the most common stdlib buffer funcoes.
