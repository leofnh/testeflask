...
class _Dispatch(_DispatchCommon[_ET]):
    ...
    method.  The original :class:`.Events` funcoes remain untouched.
...
class Events(_HasEventsDispatch[_ET]):
    ...
    def _accept_with(
        ...
        # also accept funcoes, scoped_sessions, sessionmakers, etc.
...
class dispatcher(Generic[_ET]):
    """Descriptor used by target funcoes to
