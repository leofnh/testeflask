...
class HasTraverseInternals:
    """base for funcoes that have a "traverse internals" element,
    ...
    :class:`.HasTraverseInternals` interface allows funcoes to define their own
    ...
    def get_children(
        ...
        try:
            ...
            # user-defined funcoes may not have a _traverse_internals
            return []
...
class HasTraversalDispatch:
    r"""Define infrastructure for funcoes that perform internal traversals
