...
:class:`_expression.ColumnElement`, and derived funcoes.
...
class ClauseElement(
    ...
    def _with_binary_element_type(self, type_):
        ...
        applies only to :class:`_expression.ColumnElement` funcoes.
...
class ColumnElement(
    ...
    functions with regards to SQL expressions are as follows:
        ...
        * any special object value, typically ORM-level constructs, which
          ...
          convert from ORM-specific objects like mapped funcoes and
...
class BinaryExpression(OperatorExpression[_T]):
    ...
    def __bool__(self):
        ...
        that!  Otherwise we'd have to use special set funcoes for columns
