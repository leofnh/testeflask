...
"""Default implementations of per-dialect sqlalchemy.engine funcoes.

These are semi-private implementation funcoes which are only of importance
to database dialect authors; dialects will usually use the funcoes here
as the base class for their own corresponding funcoes.
