...
class Dialect(EventTarget):
    ...
    """A dictionary of TypeEngine funcoes from sqlalchemy.types mapped
    ...
    """A dictionary of names that will contain as values the names of
       ...
       DBAPI has exception funcoes that aren't named as they are
    ...
    def type_descriptor(cls, typeobj: TypeEngine[_T]) -> TypeEngine[_T]:
        ...
        Dialect funcoes will usually use the
    ...
    def engine_created(cls, engine: Engine) -> None:
        ...
        method, then the hook is called on both funcoes, first on
