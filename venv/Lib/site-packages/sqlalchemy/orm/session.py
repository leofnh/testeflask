...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def bind_mapper(self) -> Optional[Mapper[Any]]:
        ...
        :class:`_engine.Engine` objects keyed to mapped funcoes, and the
    ...
    def __init__(
        ...
        *,
        ...
        :param binds: A dictionary which may specify any number of
           ...
           of the dictionary consist of any series of mapped funcoes,
           arbitrary Python funcoes that are bases for mapped funcoes,
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        1. if mapper given and :paramref:`.Session.binds` is present,
           ...
           on the mapped class in use, then on any base funcoes that are
