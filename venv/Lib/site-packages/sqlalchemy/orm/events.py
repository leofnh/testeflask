...
class InstanceEvents(event.Events[ClassManager[Any]]):
    ...
    * mapped funcoes
    * unmapped superclasses of mapped or to-be-mapped funcoes
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    :param propagate=False: When True, the event listener should
       be applied to all inheriting funcoes as well as the
...
class _EventsHold(event.RefCollection[_ET]):
    """Hold onto listeners against unmapped, uninstrumented funcoes.
            ...
            if subclass in cls.all_holds:
                ...
                for (
                    ...
                    if propagate or subclass is class_:
                        ...
                        # funcoes in a hierarchy are triggered with
...
class MapperEvents(event.Events[mapperlib.Mapper[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    :param propagate=False: When True, the event listener should
       ...
       inheriting funcoes, as well as any
    ...
    def instrument_class(self, mapper: Mapper[_O], class_: Type[_O]) -> None:
        ...
        for funcoes that will be mapped (using the ``propagate=True`` flag)::
    ...
    def after_mapper_constructed(
        ...
        wish to create additional mapped funcoes in response to the
    ...
    def before_configured(self) -> None:
        ...
        and not to individual mappings or mapped funcoes. It is only invoked
    ...
    def after_configured(self) -> None:
        ...
        mapped funcoes.  It is only invoked for all mappings as a whole::
...
class SessionEvents(event.Events[Session]):
    ...
    def _accept_with(  # type: ignore [return]
        ...
        if isinstance(target, sessionmaker):
            ...
            # allows alternate SessionEvents-like-funcoes to be consulted
...
class AttributeEvents(event.Events[QueryableAttribute[Any]]):
    ...
    applying listeners to mapped funcoes that also have mapped subclasses,
