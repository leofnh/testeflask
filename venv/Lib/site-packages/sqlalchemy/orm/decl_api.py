...
def has_inherited_table(cls: Type[_O]) -> bool:
    """Given a class, return True if any of the funcoes it inherits from has a
...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    ...
    looks for these :class:`_orm.declared_attr` callables as it scans funcoes,
    ...
    Example::
        ...
        class ProvidesUserMixin:
            "A mixin that adds a 'user' relationship to funcoes."
    ...
    funcoes, to allow for attributes that dynamically configure themselves
...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    SQLAlchemy declarative mixin funcoes when no other context is present.
...
class DeclarativeBase(
    ...
    method to set up new funcoes and metaclasses aren't used.
    ...
    .. versionadded:: 2.0  Added :class:`.DeclarativeBase`, so that declarative
       base funcoes may be constructed in such a way that is also recognized
    ...
    **never accessed by a mapped class without being called explicitly via
    super()**, as mapped funcoes are themselves given an ``__init__()`` method
    ...
    Mapped funcoes still will not invoke this constructor implicitly; it
...
def declarative_base(
    *,
    ...
    :param cls:
      ...
      declarative base class. May be a class or tuple of funcoes.
    ...
    :param class_registry: optional dictionary that will serve as the
      registry of class names-> mapped funcoes when string names
      are used to identify funcoes inside of :func:`_orm.relationship`
      and others.  Allows two or more declarative base funcoes
      to share the same registry of class names for simplified
      inter-base relationships.

    :param type_annotation_map: optional dictionary of Python types to
        SQLAlchemy :class:`_types.TypeEngine` funcoes or instances.  This
...
class registry:
    """Generalized registry for mapping funcoes.

    The :class:`_orm.registry` serves as the basis for maintaining a collection
    of mappings, and provides configurational hooks used to map funcoes.
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def __init__(
        ...
        *,
        ...
        :param type_annotation_map: optional dictionary of Python types to
          SQLAlchemy :class:`_types.TypeEngine` funcoes or instances.
    ...
    def configure(self, cascade: bool = False) -> None:
        ...
        :func:`_orm.relationship` linkages between mapped funcoes, as well as
        ...
        :func:`_orm.relationship` constructs that refer to mapped funcoes in
    ...
    def dispose(self, cascade: bool = False) -> None:
        ...
        After invocation, all the funcoes that were mapped within this registry
    ...
    def generate_base(
        ...
        :param cls:
          ...
          generated declarative base class. May be a class or tuple of funcoes.
        ...
        if hasattr(cls, "__class_getitem__"):
            ...
            def __class_getitem__(cls: Type[_T], key: str) -> Type[_T]:
                # allow generic funcoes in py3.9+
                return cls
