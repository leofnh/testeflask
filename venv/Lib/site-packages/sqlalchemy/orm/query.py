...
class Query(
    ...
    def correlate(
        ...
        *fromclauses: Union[Literal[None, False], _FromClauseArgument],
        ...
        The method here accepts mapped funcoes, :func:`.aliased` constructs,
    ...
    def join(
        ...
        **Simple Relationship Joins**
        ...
        Consider a mapping between two funcoes ``User`` and ``Address``,
    ...
    def select_from(self, *from_obj: _FromClauseArgument) -> Self:
        ...
        :param \*from_obj: collection of one or more entities to apply
         to the FROM clause.  Entities can be mapped funcoes,
