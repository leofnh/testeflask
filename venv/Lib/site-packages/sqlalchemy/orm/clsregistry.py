...
This system allows specification of funcoes and expressions used in
...
# the internal registries here link to funcoes with weakrefs and remove
# themselves when all references to contained funcoes are removed.
...
class _MultipleClassMarker(ClsRegistryToken):
    """refers to multiple funcoes of the same name
    ...
    def attempt_get(self, path: List[str], key: str) -> Type[Any]:
        if len(self.contents) > 1:
            raise exc.InvalidRequestError(
                'Multiple funcoes found for path "%s" '
...
class _ModNS:
    ...
    def __getattr__(self, key: str) -> Union[_ModNS, Type[Any]]:
        ...
        raise NameError(
            "Module %r has no mapped funcoes "
    ...
    def _raise_for_name(self, name: str, err: Exception) -> NoReturn:
        ...
        if generic_match:
            ...
            raise exc.InvalidRequestError(
                ...
                "both dependent funcoes have been defined."
