...
Contains various base funcoes used throughout the ORM.

Defines some key base funcoes prominent within the internals.

This module and the funcoes within are mostly private, though some attributes
...
class CompileStateOption(HasCacheKey, ORMOption):
    """base for :class:`.ORMOption` funcoes that affect the compilation of
    ...
    a SQL string is being compiled. As such, these funcoes implement
    ...
    :class:`.LoaderOption` and :class:`.CriteriaOption` funcoes.
