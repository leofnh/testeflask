...
def _is_supercls_for_inherits(cls: Type[Any]) -> bool:
    ...
    not include funcoes with _sa_decl_prepare_nocascade (e.g.
    ``AbstractConcreteBase``); these concrete-only funcoes are not set up as
...
def _get_immediate_cls_attr(
    ...
    a mapped class independently from any mapped funcoes that it may
    inherit from.
...
class _ClassScanMapperConfig(_MapperConfig):
                ...
                if name in _include_dunders:
                    ...
                    if isinstance(obj, (Column, MappedColumn)):
                        ...
                        raise exc.InvalidRequestError(
                            ...
                            "on declarative mixin funcoes.  For dataclass "
    ...
    def _setup_dataclasses_transforms(self) -> None:
        ...
        if "__dataclass_fields__" in self.cls.__dict__:
            raise exc.InvalidRequestError(
                ...
                "base funcoes / decorator styles of establishing dataclasses "
                "are not being mixed. "
        ...
        if warn_for_non_dc_attrs:
            for (
                ...
                util.warn_deprecated(
                    ...
                    f"Dataclasses, ensure that all mixin funcoes and other "
            ...
            if _is_declarative_props(value):
                ...
                if value._cascading:
                    util.warn(
                        ...
                        "Declarative 'mixin' and 'abstract' funcoes.  "
    ...
    def _prepare_mapper_arguments(self, mapper_kw: _MapperKwArgs) -> None:
        ...
        if self.inherits and not mapper_args.get("concrete", False):
            ...
            # mapping columns specific to sibling/nephew funcoes
