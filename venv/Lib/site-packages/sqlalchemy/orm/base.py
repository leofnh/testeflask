...
class InspectionAttr:
    ...
    the need to import all of these funcoes, and also such that
...
class InspectionAttrInfo(InspectionAttr):
    ...
    is that the former is compatible as a mixin for funcoes that specify
...
class _MappedAnnotationBase(Generic[_T], TypingOnly):
    """common class for Mapped and similar ORM container funcoes.

    these are funcoes that can appear on the left side of an ORM declarative
...
class Mapped(
    ...
    .. tip::
        ...
        Python descriptor funcoes that are provided as extensions, including
