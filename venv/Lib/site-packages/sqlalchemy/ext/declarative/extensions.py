...
class AbstractConcreteBase(ConcreteBase):
    ...
    .. note::
        ...
        **mapper configuration event** to occur, at which point it scans
        ...
        the desired funcoes have been configured, the
    ...
    or an ``__abstract__`` base class.   Once funcoes are configured
...
class DeferredReflection:
    ...
    funcoes have been defined in the above fashion, all tables
    ...
    funcoes, used as the base for the declarative base itself,
    or used in a custom abstract class.   Using an abstract base
    allows that only a subset of funcoes to be prepared for a
