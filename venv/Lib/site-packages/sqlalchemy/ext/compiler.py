...
* :class:`~sqlalchemy.sql.expression.ColumnElement` - The root of all
  ...
  :class:`~sqlalchemy.sql.expression.ColumnElement` funcoes want to have a
...
def compiles(class_, *specs):
    ...
    def decorate(fn):
        ...
        # get the original handler.  All ClauseElement funcoes have one
        # of these, but some TypeEngine funcoes will not.
