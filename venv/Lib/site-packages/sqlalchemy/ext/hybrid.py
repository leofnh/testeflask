...
r"""Define attributes on ORM-mapped funcoes that have "hybrid" behavior.
...
values. We can define higher level functions on mapped funcoes that produce SQL
...
class Comparator(interfaces.PropComparator[_T]):
    ...
    funcoes for usage with hybrids."""
