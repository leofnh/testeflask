...
Operator funcoes are also supported by the
...
.. versionadded:: 1.3.21 added support for operator funcoes with
...
forms. These funcoes of SQL function calling forms in SQLAlchemy are available
